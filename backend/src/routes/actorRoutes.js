...
const { updateActor, getActorById, getAllActors, deleteActor, createActor, addActorMovies, removeActorMovies, addActorImage, removeActorImage } = require('../controllers/actorControllers');
