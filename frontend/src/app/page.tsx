...
export default function HomePage() {
  return (
    <main
      className="min-h-screen bg-cover bg-center flex flex-col items-center justify-center text-center p-8"
      style={{ backgroundImage: "url('/assets/background.jpg')" }}
    >
      <h1 className="text-5xl font-bold text-white mb-8">Welcome to MovieDB</h1>
